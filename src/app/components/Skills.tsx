...
export function Skills() {
  ...
  return (
    <section
      id="skills"
      className="py-20 md:py-32 relative overflow-hidden bg-muted/30 dark:bg-muted/10"
    >
      {/* Background Pattern */}
              ...
              >
                ...
                <div className="relative bg-card border border-border rounded-2xl p-6 md:p-8 hover:border-primary-500/50 dark:hover:border-primary-400/50 transition-all">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div
                      className={`ml-auto h-1 w-20 rounded-full bg-gradient-to-r ${category.gradient} hidden md:block`}
                    />
                  </div>
